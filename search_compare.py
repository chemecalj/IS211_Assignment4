#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""IS_211 Week 4 Assignment Part 1"""
...
def list_gen(maxval):
    samplelist = random.sample(xrange(1, (maxval + 1)), maxval)
    return samplelist
...
def main():
    ...
    for sample in sample_size:
        ...
        print
        for test in tests:
            print ('%s Search took %0.7f seconds to run, '
                   'on average.') % (test, tests[test] / counter)
